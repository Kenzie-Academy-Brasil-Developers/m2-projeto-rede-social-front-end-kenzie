...
let novadivpaiul = document.querySelector(".novadivpaiul");
...
let limobile3 = document.createElement("li");
limobile3.classList.add("limobile3");

let divcargousermobile3 = document.createElement("div");
divcargousermobile2.classList.add("divcargouser");

let usercard3mobile = document.createElement("p");
usercard3mobile.innerHTML = users[6].user;
usercard3mobile.classList.add("usercard2");

let imgaside3mobile = document.createElement("img");
imgaside3mobile.classList.add("imgasidemmobile2");
imgaside3mobile.src = users[6].img;

let cargoaside3mobile = document.createElement("span");
cargoaside3mobile.classList.add("cargoaside2");
cargoaside3mobile.innerHTML = users[6].stack;

let botaoseguirmobile3 = document.createElement("button");
botaoseguirmobile3.innerHTML = "Seguir";
botaoseguirmobile3.classList.add("botaoseguirmobile2");

ul1mobile.append(limobile, limobile2,limobile3);
asidemobile.append(ul1mobile, tituloasidemobile);
novadivpaiul.append(asidemobile);


divcargousermobile3.append(usercard3mobile, cargoaside3mobile);
limobile3.append(imgaside3mobile, divcargousermobile3, botaoseguirmobile3);
/*
let paidetudo = document.querySelector(".paideasidemobile")
paidetudo.appendChild(novadivpaiul)
let body2 = document.querySelector("body")
body2.append(paidetudo)*/
